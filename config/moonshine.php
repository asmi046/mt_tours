...
return [
    ...
    'title' => env('MOONSHINE_TITLE', 'МирТуризма'),
    'logo' => env('MOONSHINE_LOGO', 'img/admin_logo/logo_admin.png'),
    'logo_small' => env('MOONSHINE_LOGO_SMALL', 'img/admin_logo/logo_admin_min.png'),
