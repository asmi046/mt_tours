...
Давай сделаем разметку для созданного модального окна:

- В врхней части шаблона вставляем изображение (@public/img/school/m_img.webp) и скругляем ему края. Растягиваем это изображение на всю ширину модального окна.
- Ниже блок с призывом в который размести h2 с текстом Подберём тур для вашего класса и параграф с текстом Оставьте заявку — мы свяжемся и предложим лучшие варианты.
- Внизу блока размести форму по аналогии с компонентом @resources/js/components/ModalWindow.vue и сохрани его функциональность, предварительно предложи варианты по реализации этого пункта.

Разметку помести в scss файл public/scss/\_modal_schol.scss
