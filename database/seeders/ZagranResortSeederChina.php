    ...
    public function run(): void
    {
        ...
        if ($chinaId) {
            ...
            $resorts[] = [
                ...
                'order' => 5,
                'slug' => 'beijing',
                'hot_tours_script' => '<div class="tv-hot-tours" tv-view="1" tv-rows="10" tv-width="auto" tv-imgpos="1" tv-showfilters="" tv-borderwidth="false" tv-countries="4" tv-resorts="25" tv-departure="32" tv-departure2="1" tv-departure3="26"></div>',
                'description' => null,
